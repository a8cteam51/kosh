...
tests/           node --test checks for the scripts, skill snippets, shared-block copies, JSON files, skill ↔ schema drift, report validation and redacted report fixtures — run by .github/workflows/ci.yml on every PR
