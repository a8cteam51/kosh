...
for (const [name, src, stub, category] of [
  ...
  ['w= delivered 1px under the request', 'https://example.com/chart.png?w=1024', { natural: [1023, 644], slot: [877, 552] }, 'request'],
  ['w= delivered 2px under the request', 'https://example.com/chart.png?w=1024', { natural: [1022, 644], slot: [877, 552] }, 'request'],
  ['w= delivered 3px under the request', 'https://example.com/chart.png?w=1024', { natural: [1021, 643], slot: [877, 552] }, 'source'],
  ['fit= whose height came back 1px under', 'https://cdn.example.com/thumb.jpg?fit=350%2C200', { natural: [299, 199], slot: [305, 172] }, 'request'],
  ['w= on a 4:1 banner delivered 4px under', 'https://example.com/hero.png?w=1200', { natural: [1196, 299], slot: [1100, 275] }, 'request'],
  ['w= delivered 1px over the request', 'https://example.com/chart.png?w=1024', { natural: [1025, 645], slot: [877, 552] }, 'source'],
  ['w= already sufficient on its own axis, image short on the other', 'https://example.com/wide.png?w=1024', { natural: [1024, 300], slot: [500, 200] }, 'source'],
  ['w= 1px under, measured through the probe of a 2x pick', 'https://example.com/chart.png?w=1024', { natural: [512, 322], real: [1023, 644], slot: [877, 552], srcset: 'https://example.com/chart.png?w=1024 2x' }, 'request'],
