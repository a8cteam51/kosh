...
Navigate to the extracted URL and conduct a performance-focused QA test by following the full procedure below, using the determined environment type to guide how findings are reported.
